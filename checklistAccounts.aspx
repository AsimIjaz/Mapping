<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="checklistAccounts.aspx.cs" Inherits="mapping.checklistAccounts" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head id="Head1" runat="server">
        <title>CLOXXS - GROOTBOEKREKENINGEN ZONDER MAPPING</title>
    </head>
        ...
        <form id="formMain" runat="server">
          ...
          <div style="height: 20px; width: 1150px; background-color: #ffffff;">
            ...
            <asp:Label ID="labelTitle" runat="server" 
                Text="GROOTBOEKREKENINGEN ZONDER MAPPING" Font-Bold="True" Font-Names="Arial" 
            ...
            <div style="width: 1150px; float:none; background-color: #ffffff;">
                ...
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                    TypeName="mapping.BusinessObjectDATA" SelectMethod="SelectAccountsNotMapped">
            ...
            <div style="width: 1150px; float:none; background-color: #ffffff;">
                ...
                <asp:GridView ID="GridView1" runat="server" DataSourceID="ObjectDataSource1" 
                    ...
                    Font-Names="Arial" Font-Size="12px" DataKeyNames="GROOTBOEKREKENING" 
                    ondatabound="GridView1_DataBound" ondatabinding="GridView1_DataBinding">
                    <Columns>

                        <asp:BoundField DataField="GROOTBOEKREKENING" HeaderText="GROOTBOEKREKENING" 
                            ReadOnly="True">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle Width="100px" Wrap="True" />
                        </asp:BoundField>

                        <asp:BoundField DataField="TAAKNUMMER" HeaderText="TAAKNUMMER" 
                            ReadOnly="True">
                        <HeaderStyle HorizontalAlign="Left" />
